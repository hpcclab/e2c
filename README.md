...
- When viewing the website, reloading the can only be completed on the home page (hpcclab.github.io/e2c/), and not on derivative pages (Simulation, Reports, etc.)
